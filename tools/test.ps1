...
try{
 ...
 node --test tests/editor/controller.test.cjs tests/editor/adapter.test.cjs tests/editor/launcher.test.cjs tests/editor/dialogs.test.cjs tests/editor/panel-drag.test.cjs
